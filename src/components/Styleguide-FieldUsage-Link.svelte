<script>
  import { Link, getFieldValue } from "jss-svelte";
  ...
  <StyleguideSpecimen {...specimanProps} e2eId="styleguide-fieldusage-link">
    External link:&nbsp;
    <Link field={fields.externalLink} />
    <br />
    Internal link:&nbsp;
    <Link field={fields.internalLink}>
